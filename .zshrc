...
plugins=(gitfast git-extras autojump npm zsh-syntax-highlighting history-substring-search go)

# User configuration

export PATH="/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:./node_modules/.bin"
